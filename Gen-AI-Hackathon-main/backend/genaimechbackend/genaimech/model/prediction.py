...
DATA_DIR = BASE_DIR / "genaimech" / "model" / "data"

data_asthma = pd.read_csv(DATA_DIR / "asthma.csv")
data_cancer = pd.read_csv(DATA_DIR / "cancer.csv")
data_diabetes = pd.read_csv(DATA_DIR / "diabetes.csv")
data_stroke = pd.read_csv(DATA_DIR / "stroke.csv")
